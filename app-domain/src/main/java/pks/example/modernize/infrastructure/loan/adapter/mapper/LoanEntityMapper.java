package pks.example.modernize.infrastructure.loan.adapter.mapper;
...
import pks.example.modernize.infrastructure.loan.adapter.entity.LoanEntity;
...
public interface LoanEntityMapper {
     ...
     * @return
     * 
     * deprecated Use {@link pks.example.modernize.infrastructure.loan.adapter.mapper.LoanEntityMapper.pet.infra.mapper.PetEntityMapper#updatePetEntityFromPet(Pet, PetEntity)} instead as you should always look for the entity before creating a new one.
     */
    // @Deprecated
