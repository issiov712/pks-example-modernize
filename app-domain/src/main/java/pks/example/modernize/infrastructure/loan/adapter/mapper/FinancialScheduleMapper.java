...
import pks.example.modernize.domain.loan.model.FinancialSchedule;
import pks.example.modernize.infrastructure.loan.adapter.entity.FinancialScheduleEntity;
